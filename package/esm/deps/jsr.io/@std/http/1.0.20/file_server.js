 ...
 * @module
 */
import { normalize as posixNormalize } from "../../path/1.1.2/posix/normalize.js";
import { extname } from "../../path/1.1.2/extname.js";
import { join } from "../../path/1.1.2/join.js";
import { relative } from "../../path/1.1.2/relative.js";
import { resolve } from "../../path/1.1.2/resolve.js";
import { SEPARATOR_PATTERN } from "../../path/1.1.2/constants.js";
...
import { ByteSliceStream } from "../../streams/1.0.12/byte_slice_stream.js";
import { parseArgs } from "../../cli/1.0.22/parse_args.js";
import denoConfig from "./deno.js";
import { format as formatBytes } from "../../fmt/1.0.8/bytes.js";
import { getNetworkAddress } from "../../net/1.0.6/unstable_get_network_address.js";
import { escape } from "../../html/1.0.4/entities.js";
import { HEADER } from "./unstable_header.js";
import { METHOD } from "./unstable_method.js";
const ENV_PERM_STATUS = dntShim.Deno.permissions.querySync?.({ name: "env", variable: "DENO_DEPLOYMENT_ID" })
    .state ?? "granted"; // for deno deploy
const NET_PERM_STATUS = dntShim.Deno.permissions.querySync?.({ name: "sys", kind: "networkInterfaces" })
    .state ?? "granted"; // for deno deploy
...
async function serveDirIndex(dirPath, options) {
    ...
    if (dirUrl !== "/") {
        ...
        const entryInfo = dntShim.Deno.stat(prevPath).then((fileInfo) => ({
