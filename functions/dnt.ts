...
// import { ssgDocument } from './ssg.ts';
...
await build({
    ...
    //     // await ssgDocument();
    //     // console.log('ssgDocument done');

    //     // await ensureDir(`${OUT_DIR}/components`);
    //     // Deno.copyFileSync("components/button.css", `${OUT_DIR}/esm/components/button.css`);
    //     // Deno.copyFileSync("components/counter.css", `${OUT_DIR}/esm/components/counter.css`);
